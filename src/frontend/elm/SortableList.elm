...
type alias Items = Array Item

type alias Item = {
  text : String,
}

type Distance = Distance HorizontalDistance VerticalDistance

type alias Delta = (HorizontalDistance, VerticalDistance)

type alias Index = Int

type alias VerticalDistance = Float

type alias HorizontalDistance = Float
...
view {items, draggingItemIndex, draggedDistance} =
  ...
  (Array.toList <|
    Array.indexedMap (itemView draggingItemIndex draggedDistance) items)
